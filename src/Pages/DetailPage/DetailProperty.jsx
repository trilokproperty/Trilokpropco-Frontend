 ...
 <div className="text-center border py-6 px-3 rounded-2xl">
      ...
      {selectedPlan && (
        ...
        <p className="detailedProperty text-black text-[14px]">{amenity?.name}</p>
          ...
          <img src="https://i.ibb.co.com/w7HGyvB/Adobe-PDF.webp" alt="Download Brochure | Trilokpropco Real Estate Agent" className="md:w-[200px] w-[130px] absolute left-[-26px]"/><span className="md:ml-20 ml-12 md:text-2xl text-xl font-light ">Download Brochure</span></button></a>
          </div>
